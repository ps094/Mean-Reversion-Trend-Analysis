...
struct Config {
    ...
    long int parent_sim_size = 8515584;
    int child_sim_size = 22176;
    short int thread_size = 384;
    std::string file_location = "/Users/praneetshaw/Desktop/Strategy/CFiles/";
    ...
    std::string Simulated_Parameter_Collection = "Simulated_Parameters"; //Postfix
...
//    float pos_increment = 0.01f, mov_increment = 0.01f, prof_increment = 0.01f;
    float pos_increment = 0.005f, mov_increment = 0.005f, prof_increment = 0.005f;
};
